...
public class AppConfig {
  ...
  // The number of rows to read in a single operation. 
  public int operationRowSize = 1;
  ...
  public String preparedStatementString;
  ...
  public String dbUsername = "yugabyte";
  ...
  // File to write the JSON metrics to.
  public String jsonMetricsFile = null;
